...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> saveImages(@RequestParam List<MultipartFile> files, @RequestParam Long productId){
        try {
            ...
            return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(new ApiResponse("failed save", e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse> updateImage(@PathVariable Long imageId, @RequestBody MultipartFile file) {
        try {
            ...
            return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(new ApiResponse("failed update", INTERNAL_SERVER_ERROR));
    ...
    public ResponseEntity<ApiResponse> deleteImage(@PathVariable Long imageId) {
        ...
        return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(new ApiResponse("failed delete", INTERNAL_SERVER_ERROR));
    }
}
