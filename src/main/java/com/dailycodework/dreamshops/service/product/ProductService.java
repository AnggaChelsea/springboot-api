...
public class ProductService implements IProductService {
    ...
    private final com.dailycodework.dreamshops.repository.CategoryRepository categoryRepository;
    ...
    @Override
    public List<Product> getProductByBrandAndProductName(String brand, String name) {
